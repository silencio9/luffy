						...
						<div class="content-detail">
							<div>
								<img src="data:image/svg+xml;base64," alt="">
							      ...
							      <span class="span4">￥{{course.price}}</span>
...
export default {
  ...
  name: 'Course',
  // 生命周期，在createed中发送ajax请求
  data(){
  	return {
  		categoryList:[],//分类列表
  		currentIndex:0,//当前分类索引
  		categoryId:0,//获取所有的课程列表ID
  		courseDetail:[],//课程列表详情数据
  		bgColors:['#4AB2BF','#1895C6','#4C87E0','#A361D9','#F7AE6A','#FF14A0','#61F0E1','#6282A7','#27998E','#3C74CC','#A463DA','#F0A257','#DD4B7A','#59C6BD','#617FA1','#1B92C3','#30A297','#3B73CB','#9E57CA','#A463DA','#1895C6','#A361D9','#FF14A0'] //背景颜色
  ...
  methods:{
  	...
  	//获取分类列表
  	getCategoryList(){
  		this.$http.categoryList(this.categoryId)
  	.then(res=>{
