...
class CourseDetailSerializer(serializers.ModelSerializer):
    ...
    def get_teachers(self, obj):
        return [{'id': teacher.id, 'title': teacher.name} for teacher in obj.teachers.all()]
    ...
    class Meta:
        ...
        fields = ['id', 'hours', 'summary', 'level', 'study_num', 'recommend_courses', 'teachers',
                  'price_policy', 'course_outline', 'video_brief_link', 'why_study', 'what_to_study_brief',
                  'career_improvement', 'prerequisite', 'course_slogan']
